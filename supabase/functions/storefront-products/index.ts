...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data: products, error: productsError } = await supabase
      .from('products')
      .select('id, name, pricePer, unit, variant_size, variant_unit, image_url, category, qty, description, tax_behavior, allow_pre_order, is_deposit_product, deposit_prod_price_per_lb, deposit_fixed_total, order_mode, pack_for_you_min_lbs, pack_for_you_step_lbs, pack_for_you_max_overage_pct, pack_for_you_max_underage_pct, pack_for_you_price_buffer_pct, reserved_weight_lbs', { count: 'exact' })
