...
/>
          ...
          <div className="relative max-w-7xl mx-auto px-1 sm:px-3 md:px-5 lg:px-8 py-10 md:py-10 lg:py-14">
...
<section id="products" className="flex-1 py-8 md:py-12 bg-slate-50">
  <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
    ...
    {/* Product cards */}
    <div className="grid gap-3 sm:gap-4 md:gap-5 lg:gap-6 grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
      ...
      {filteredProducts.map((product) => {
        ...
        return (
          <ProductCard
            ...
            cart={cart}
            onAddToCart={(options) => {
              // If this is a subscription product, show the modal instead
